...
exports.handler = async function(event) {
  ...
  try {
    ...
    const transporter = nodemailer.createTransport({
      ...
      port: 587,
      auth: {
        user: "a897c3001@smtp-brevo.com",
        pass: "xsmtpsib-8d881850a7b53ce63bace5f2ef9547a07cc3f0af8040adf033580172e9666410-y5xI5kysNSYEfRI0"
      }
    });

    await transporter.sendMail({
      from: "a897c3001@smtp-brevo.com",
      to: to,
      subject: subject,
      text: message,
      html: `<p>${message}</p>`
